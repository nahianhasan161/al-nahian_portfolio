...
import Github from "@/app/assets/icons/marketplace/github.svg";
...
export default React.forwardRef(function GetInTouchSection(
  ...
  return (
    <>
      <div
        className="pt-[180px] flex flex-col gap-[80px]  items-start  max-w-[334px] xl:max-w-[364px] mx-auto"
        id="contact"
      >
        <div className="space-y-[30px] ">
          ...
          <a
            ...
            className="block py-3  px-7 2xl:py-[18px] 2xl:px-9 border-[.5px] 
            rounded-lg text-xl text-[26px] tracking-[1px]
        ...
        <div className="flex w-full items-center justify-between">
          <Link href={details.Linkedin} className="group" ref={props.addToRefs}>
          ...
          <Link href={details.fiver} className="group " ref={props.addToRefs}>
          ...
          <Link href={details.github} className="group" ref={props.addToRefs}>
            <Github className="svg-hover w-[52px] h-[45px] " />
            <hr
              className="w-0 mx-[5
